...
label ch1ep3:
    ...
    if len(visitedPlaces & {"shop1", "shop2"}) > 1:
        ...
        fox "*Завтра я покину этот город.*"
    else:
        fox "*Лучше отогнать эти мысли. Не думаю, что я кому-то интересен сейчас.*"
    fox "*М-м-м, запах пряных булочек. Зайду купить их для местной ребятни, они обожают эти булочки.*"
    fox "Привет, Томас! Мне, как обычно, 12 пряных булочек."
    tom "Балуешь ты этих оборванцев. О них сегодня спрашивали стражники. Они снова набедокурили."
    ...
    menu:
        ...
        "Давай":
            "Да, давай, я их очень давно не ел."
        "Не стоит":
            "Не стоит, у них есть вкус воспоминания, что отдаёт сейчас горечью."
    tom "Бывай и приходи ещё!"
    fox "Бывай!"

    fox "*Помню, мы с Айрис часто объедались ими и смотрели на проплывающий в лучах луны Летающий город и мечтали о жизни там.*"
    fox "*И как только я продам эти свитки, я перееду в Летающий город и заживу свою лучшую жизнь. Айрис от зависти бы лопнула.*"
    "" "*Бдыщ*"
    menu:
